                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rating">
                                    <!-- <option value="{{$Products->rating}}" disabled>{{$Products->rating}}</option> -->
                                     <option value="1" @if($Products->rating == 1) selected @endif >1</option>
                                     <option value="2" @if($Products->rating == 2) selected @endif>2</option>
                                      <option value="3" @if($Products->rating == 3) selected @endif>3</option>
                                       <option value="4" @if($Products->rating == 4) selected @endif>4</option>
                                        <option value="5" @if($Products->rating == 5) selected @endif>5</option>
                                </select> 
                            </div>
                        </div>
                          <div class="col-md-12">
