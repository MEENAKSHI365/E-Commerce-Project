    ...
    <br>
      <div class="row ">
        ...
        <div  align="center" class="col-md-8 wow animated flash slow">
            <h1 class="black-text" style="font-weight:bold;">Values of  Coziq</h1>
    ...
    <div  class="row my-4 px-4 "  style="width:100%;" >
      ...
      <div class="col-md-3 px-4 my-5"  >
          ...
          <div class="py-2" style="background:white;">
            ...
            $afterDiscountPrice = $item->price - $discountPrice ;
            @endphp 

            <br>₹{{$afterDiscountPrice}}
            <br> <del> ₹ {{$item->price}} </del><span style="color:green;"> {{$item->discount}}% off </span><br>
            @else 
              ...
              <div class="col-lg-5 d-flex align-items-stretch">
                <div align="left" class="info">
                  ...
                  <i class="fas fa-phone"></i>
                    <h4>Call:</h4>
                    <p>Meenakshi : +91 9876543210<br>
Jyoti : +91 9876543210</p>
                  </div>
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d805.8579362548035!2d75.87572393639843!3d26.776013996554493!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396dc9c0028a90b5%3A0xf4838385b07368b5!2sCentral%20lawn%20JECRC%20University!5e1!3m2!1sen!2sin!4v1737232795497!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
