...
<div align="left" class="px-5 py-2" style="background:#1CD5E8;margin-top:5px; ">
    ...
    <p class="my-2 " style="font-weight:bold; "><a href="{{url('/')}}" class="black-text">Home </a>/ {{$Product->name}}
    </p>
        ...
        <div class="row  d-flex align-items-center ">
            <div class="col-md-4  animated fadeInRight fast" style="width: 100%;">
                ...
                <a href="{{asset('Uploads/Products/'.$Product->image2)}}">
                    <img class="xzoom-gallery" width="80" src="{{asset('Uploads/Products/'.$Product->image2)}}"
            ...
            <div id="product_data" class="col-md-7 animated fadeInLeft fast">
                ...
                $afterDiscountPrice = $Product->price - $discountPrice ;
                @endphp

                <br> <del> ₹ {{$Product->price }} </del><span style="color:green;"> {{$Product->discount}}% off
                </span><br>
                @else
                ...
                <p> Price : <strong style="font-size:20px;font-family: 'Balsamiq Sans', cursive;">₹
                        {{$afterDiscountPrice}}</strong></p>



                <div class="col-md-6" style="margin-left:-20px;">
                    <div class="form-group">
                        <label class="form-title">Select size</label>
                        <select class="form-control size" name="size" data-parsley-required-message="size cannot be blank"
                            required>
                ...
                <div class="col-md-6" style="margin-left:-20px;">
                    <input type="number" class="form-control quantity" name="quantity" placeholder="Quantity" value="1"
                        min="1">
                </div>
