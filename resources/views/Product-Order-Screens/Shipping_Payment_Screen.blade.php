    ...
    <form method="POST" action="order-proceed">
        ...
        <div class="card  p-3 animated fadeInUp" >
            ...
            <div class="row px-3">
                <div class="col-md-12">
                    <div class="form-group">
                            <input type="radio"  name="Payment_Method" value="Online"> Online <i class="fa fa-credit-card" aria-hidden="true"></i>
                            <input type="radio"  name="Payment_Method" value="Online"> Offline <i class="fa fa-credit-card" aria-hidden="true"></i>
                    </div>
                </div>
                <!--
                <div class="col-md-12">
